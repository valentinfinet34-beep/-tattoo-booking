  ...
  return (
    <div className="relative flex min-h-full flex-col items-center px-5 py-10">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex items-center gap-2 [text-shadow:_0_2px_10px_rgb(0_0_0_/_75%)]">
        ...
        <h1 className="mb-2 text-4xl [text-shadow:_0_2px_14px_rgb(0_0_0_/_75%)]">
          Réservez votre séance
        </h1>
        <p className="mb-6 text-sm text-muted [text-shadow:_0_1px_8px_rgb(0_0_0_/_85%)]">
